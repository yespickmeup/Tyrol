 ...
 * @author Maytopacka
 */
public class Dlg_tables extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_tables(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_tables(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_tables myRef;

    private void setThisRef(Dlg_tables myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_tables> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_tables create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_tables create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_tables dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_tables((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_tables((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().
                        log(Level.INFO, "instances: {0}", dialogContainer.size());
    ...
    public static void main(String args[]) {
        ...
        Dlg_tables dialog = Dlg_tables.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        tbl_tables = new org.jdesktop.swingx.JXTable();
        ...
        tf_table_name.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
    ...
    private org.jdesktop.swingx.JXTable tbl_tables;
...
//                btn_0.doClick();
    ...
    private void init_tbl_tables() {
        ...
        int[] tbl_widths_tables = {100, 0, 0, 0};
        ...
        tbl_tables.getTableHeader().setFont(new java.awt.Font("Arial", 0, 14));
        tbl_tables.setRowHeight(35);
        tbl_tables.setFont(new java.awt.Font("Arial", 0, 14));
    }
    ...
    public static class TbltablesModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "Name", "table_name", "table_location", "table_location_id"
        };
    ...
    private void data_cols() {
        String where = "where table_name like '%" + tf_search.getText() + "%' order by table_name asc";
    ...
    private void add_tables() {
        ...
        to_tables to = new to_tables(id, table_name, table_location, table_location_id, "", "", 0);
        S1_tables.add_tables(to);
        data_cols();
        clear_tables();
        Alert.set(3, "");
    }

    private void select_tables() {
        int row = tbl_tables.getSelectedRow();
        if (row < 0) {
            return;
        }
        to_tables to = (to_tables) tbl_tables_ALM.get(tbl_tables.convertRowIndexToModel(row));
        tf_table_name.setText(to.table_name);

    }

    private void edit_tables() {
        int row = tbl_tables.getSelectedRow();
        if (row < 0) {
            return;
        }
        ...
        to_tables to1 = new to_tables(id, table_name, "", "", "", "", 0);
        S1_tables.edit_tables(to1);
        data_cols();
        clear_tables();
        Alert.set(3, "");
    }
