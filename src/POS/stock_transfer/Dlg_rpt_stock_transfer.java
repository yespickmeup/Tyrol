 ...
 * @author Maytopacka
 */
public class Dlg_rpt_stock_transfer extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_rpt_stock_transfer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_rpt_stock_transfer(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_rpt_stock_transfer myRef;

    private void setThisRef(Dlg_rpt_stock_transfer myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_rpt_stock_transfer> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_rpt_stock_transfer create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_rpt_stock_transfer create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_rpt_stock_transfer dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_rpt_stock_transfer((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_rpt_stock_transfer((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().
                        log(Level.INFO, "instances: {0}", dialogContainer.size());
    ...
    public static void main(String args[]) {
        ...
        Dlg_rpt_stock_transfer dialog = Dlg_rpt_stock_transfer.create(new javax.swing.JFrame(), true);
            ...
            .addGroup(jXPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jXPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jXPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(dp_from, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jXPanel2Layout.createSequentialGroup()
                        .addGap(10, 10, 10)
...
//                btn_0.doClick();
    ...
    private void init_tbl_receipts() {
        ...
        int[] tbl_widths_receipts = {0, 150, 0, 0, 150, 100, 0, 0};
    ...
    private void loadData_receipts(List<S1_stock_transfer.to_receipts> acc) {
    ...
    public static class TblreceiptsModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "id", "RECEIPT NO", "user_name", "session_no", "DATE", "SUPPLIER", "supllier_id", "REMARKS"
        };
        ...
        public Object getValueAt(int row, int col) {
            S1_stock_transfer.to_receipts tt = (S1_stock_transfer.to_receipts) getRow(row);
            switch (col) {
                case 0:
                    return tt.id;
                case 1:
...
//                toString();
        ...
        loadData_receipts(S1_stock_transfer.ret_data2(search, date_from, date_to));
    }
    ...
    private void init_tbl_receipt_items() {
        ...
        int[] tbl_widths_receipt_items = {0, 0, 0, 0, 0, 0, 0, 0, 0, 100, 60, 0, 0, 0, 0, 0, 0, 0};
    ...
    private void loadData_receipt_items(List<S1_stock_transfer_items.to_receipt_items> acc) {
    ...
    public static class Tblreceipt_itemsModel extends AbstractTableAdapter {
        ...
        public static String[] COLUMNS = {
            "id", "receipt_no", "user_name", "session_no", "date_added", "supplier", "supllier_id", "remarks", "barcode", "DESCRIPTION"
                , "QTY", "COST", "category", "category_id", "classification", "classification_id", "sub_class", "TOTAL"
        };
        ...
        @Override
        public Object getValueAt(int row, int col) {
            S1_stock_transfer_items.to_receipt_items tt = (S1_stock_transfer_items.to_receipt_items) getRow(row);
            switch (col) {
                case 0:
                    return tt.id;
                case 1:
    ...
    private void data_cols_items() {
        ...
        S1_stock_transfer.to_receipts to = (S1_stock_transfer.to_receipts) tbl_receipts_ALM.get(tbl_receipts.
                convertRowIndexToModel(row));
        loadData_receipt_items(S1_stock_transfer_items.ret_data(to.receipt_no));
        List<S1_stock_transfer_items.to_receipt_items> acc=tbl_receipt_items_ALM;
        
        double total=0;
        for(S1_stock_transfer_items.to_receipt_items to2: acc){
            total+=to2.qty;
        }
