...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        tbl_suppliers = new org.jdesktop.swingx.JXTable();
        ...
        tf_supplier.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        tf_supplier.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        tf_contact_no.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        tf_contact_no.setHorizontalAlignment(javax.swing.JTextField.CENTER);
    ...
    private org.jdesktop.swingx.JXTable tbl_suppliers;
...
//                btn_0.doClick();
    ...
    // </editor-fold>
    private ArrayListModel tbl_suppliers_ALM;
    private TblsuppliersModel tbl_suppliers_M;

    private void init_tbl_suppliers() {
        tbl_suppliers_ALM = new ArrayListModel();
        tbl_suppliers_M = new TblsuppliersModel(tbl_suppliers_ALM);
        tbl_suppliers.getTableHeader().
        ...
        int[] tbl_widths_suppliers = {0, 100, 100, 150};
        ...
        Dimension d = tbl_suppliers.getTableHeader().
                getPreferredSize();
        d.height = 30;
        tbl_suppliers.getTableHeader().
                setPreferredSize(d);
    ...
    private void loadData_suppliers(List<to_suppliers> acc) {
    ...
    private void data_cols() {
        ...
        loadData_suppliers(S1_suppliers.ret_data(search));
    }
    ...
    private void select_suppliers() {
        ...
        to_suppliers to = (to_suppliers) tbl_suppliers_ALM.get(tbl_suppliers.
    ...
    private void edit_suppliers() {
        ...
        S1_suppliers.edit_suppliers(to1);
        data_cols();
        clear_suppliers();
    }

    private void clear_suppliers() {
        tf_supplier.setText("");
