 ...
 * @author Maytopacka
 */
public class Dlg_z_reading extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_z_reading(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_z_reading(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_z_reading myRef;

    private void setThisRef(Dlg_z_reading myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_z_reading> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_z_reading create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_z_reading create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_z_reading dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_z_reading((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_z_reading((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().
                        log(Level.INFO, "instances: {0}", dialogContainer.size());
    ...
    public static void main(String args[]) {
        ...
        Dlg_z_reading dialog = Dlg_z_reading.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(dp_from, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//                btn_0.doClick();
    ...
    private void get_data() {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                Srpt_z_reading rpt = Srpt_z_reading.ret_data(date_from, date_to);
                String jrxml = "rpt_z_reading_1.jrxml";
    ...
    private void report_sales_items(final Srpt_z_reading to, String jrxml_name) {
    ...
    public static JRViewer get_viewer_all_sales(Srpt_z_reading to, String rpt_name) {
