 ...
 * @author Maytopacka
 */
public class Dlg_report_stock_left_supplier extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_report_stock_left_supplier(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_stock_left_supplier(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_report_stock_left_supplier() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_stock_left_supplier myRef;

    private void setThisRef(Dlg_report_stock_left_supplier myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_report_stock_left_supplier> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_report_stock_left_supplier create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_report_stock_left_supplier create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_report_stock_left_supplier dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_report_stock_left_supplier((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_report_stock_left_supplier((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().
                        log(Level.INFO, "instances: {0}", dialogContainer.size());
    ...
    public static void main(String args[]) {
        ...
        Dlg_report_stock_left_supplier dialog = Dlg_report_stock_left_supplier.
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(cb_supplier, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//                btn_0.doClick();
    ...
    private void get_data() {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            @Override
            public void run() {
                String category = cb_supplier.getSelectedItem().
                        toString();

                if (cb_supplier.getSelectedIndex() == 0) {
                    category = "";
                }
                List<Srpt_stocks_left_supplier.field> fields = Srpt_stocks_left_supplier.
                        ret_data(category);
    ...
    private void report_sales_items(final Srpt_stocks_left_supplier to, String jrxml_name) {
    ...
    public static JRViewer get_viewer_all_sales(Srpt_stocks_left_supplier to, String rpt_name) {
