...
import static POS.reports.Srpt_cash_count.ret_data;
...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(dp_from, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel3)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(dp_to, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void init_expenses() {
        ...
        Dlg_expenses dlg = new Dlg_expenses();
    ...
    private void get_sales_items() {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String where = "where Date(time_in) between '" + date_from + "' and '" + date_to + "' order by time_in asc";
                List<Srpt_cash_count.field> fields = ret_data(where);
...
//        String printed_by = "";//Users.screen_name.toUpperCase();
    ...
    private void report_sales_items(final Srpt_cash_count to, String jrxml_name) {
    ...
    public static JRViewer get_viewer_expenses(Srpt_cash_count to, String rpt_name) {
