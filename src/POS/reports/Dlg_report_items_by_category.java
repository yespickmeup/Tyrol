 ...
 * @author Maytopacka
 */
public class Dlg_report_items_by_category extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_report_items_by_category(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_items_by_category(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_report_items_by_category() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_report_items_by_category myRef;

    private void setThisRef(Dlg_report_items_by_category myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_report_items_by_category> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_report_items_by_category create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_report_items_by_category create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_report_items_by_category dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_report_items_by_category((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_report_items_by_category((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().
                        log(Level.INFO, "instances: {0}", dialogContainer.size());
    ...
    public static void main(String args[]) {
        ...
        Dlg_report_items_by_category dialog = Dlg_report_items_by_category.
    ...
    private void get_data() {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                List<Srpt_stocks_left_category.field> fields = Srpt_stocks_left_category.
                        ret_data_items_by_category(category);
                ...
                String jrxml = "rpt_items_category.jrxml";
