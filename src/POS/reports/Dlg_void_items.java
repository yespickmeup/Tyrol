 ...
 * @author Ronald
 */
public class Dlg_void_items extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_void_items
     */
...
//</editor-fold>
    ...
    private Dlg_void_items(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_void_items(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_void_items myRef;

    private void setThisRef(Dlg_void_items myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_void_items> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_void_items create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_void_items create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_void_items dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_void_items((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_void_items((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_void_items dialog = Dlg_void_items.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(dp_to, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
...
//                btn_0.doClick();
    ...
    private void get_data() {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String where="where Date(date_added) between '"+date_from+"' and '"+date_to+"' order by description asc";
                List<Srpt_void_items.field> fields = Srpt_void_items.ret_data(where);
                ...
                String sales_date = "Date: [" + DateType.slash.format(dp_from.getDate()) + "]" + " - " + "[" + DateType.slash.format(dp_to.getDate()) + "]";
    ...
    private void report_sales_items(final Srpt_void_items to, String jrxml_name) {
    ...
    public static JRViewer get_viewer_all_sales(Srpt_void_items to, String rpt_name) {
