...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        tf_expense_name.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        tf_expense_name.setHorizontalAlignment(javax.swing.JTextField.LEFT);
...
//                btn_0.doClick();
    ...
    private void init_tbl_expenses() {
        ...
        tbl_expenses.getTableHeader().
                setPreferredSize(d);
        tbl_expenses.getTableHeader().
                setFont(new java.awt.Font("Arial", 0, 0));
        tbl_expenses.setRowHeight(35);
        tbl_expenses.setFont(new java.awt.Font("Arial", 0, 11));
    }
