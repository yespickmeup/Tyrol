...
//</editor-fold>
    ...
    private void initComponents() {
        ...
        tbl_credit_cards = new org.jdesktop.swingx.JXTable();
        ...
        tf_credit_card.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        tf_credit_card.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        ...
        jXPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jXPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jXPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tf_credit_card, javax.swing.GroupLayout.DEFAULT_SIZE, 438, Short.MAX_VALUE)
                    .addGroup(jXPanel2Layout.createSequentialGroup()
                        .addComponent(tf_rate, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private org.jdesktop.swingx.JXTable tbl_credit_cards;
    ...
    private void focus() {
        JTextField[] tf = {tf_search, tf_credit_card, tf_rate};
...
//                btn_0.doClick();
    ...
    private ArrayListModel tbl_credit_cards_ALM;
    private Tblcredit_cardsModel tbl_credit_cards_M;

    private void init_tbl_credit_cards() {
        tbl_credit_cards_ALM = new ArrayListModel();
        tbl_credit_cards_M = new Tblcredit_cardsModel(tbl_credit_cards_ALM);
        tbl_credit_cards.getTableHeader().setPreferredSize(new Dimension(100, 40));
        ...
        tbl_credit_cards.getTableHeader().setFont(new java.awt.Font("Arial", 0, 11));
        tbl_credit_cards.setRowHeight(35);
        tbl_credit_cards.setFont(new java.awt.Font("Arial", 0, 11));
    }

    private void loadData_credit_cards(List<to_credit_cards> acc) {
    ...
    private void data_cols() {
        ...
        loadData_credit_cards(S1_credit_cards.ret_data(search));
    }

    private void add_credit_cards() {
        int id = -1;
        String credit_card = tf_credit_card.getText();
    ...
    private void select_credit_cards() {
        ...
        to_credit_cards to = (to_credit_cards) tbl_credit_cards_ALM.get(tbl_credit_cards.convertRowIndexToModel(row));
        tf_credit_card.setText(to.credit_card);
        tf_rate.setText(FitIn.fmt_wc_0(to.rate));
    }

    private void edit_credit_cards() {
        int row = tbl_credit_cards.getSelectedRow();
        if (row < 0) {
            return;
        }
        ...
        String credit_card = tf_credit_card.getText();
        double rate = FitIn.toDouble(tf_rate.getText());
        to_credit_cards to1 = new to_credit_cards(id, credit_card, rate);
    ...
    private void clear_credit_cards() {
        tf_credit_card.setText("");
        tf_rate.setText("");
    }
