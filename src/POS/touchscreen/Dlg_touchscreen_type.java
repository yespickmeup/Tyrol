 ...
 * @author Ronald
 */
public class Dlg_touchscreen_type extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_touchscreen_type(java.awt.Frame parent, boolean modal) {
    ...
    private Dlg_touchscreen_type(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_touchscreen_type myRef;

    private void setThisRef(Dlg_touchscreen_type myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_touchscreen_type> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_touchscreen_type create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_touchscreen_type create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_touchscreen_type dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_touchscreen_type((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_touchscreen_type((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_touchscreen_type dialog = Dlg_touchscreen_type.create(new javax.swing.JFrame(), true);
