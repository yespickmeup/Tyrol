 ...
 * @author Ronald
 */
public class Dlg_touchscreen_expenses extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_touchscreen_expenses(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_touchscreen_expenses(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_touchscreen_expenses() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_touchscreen_expenses myRef;

    private void setThisRef(Dlg_touchscreen_expenses myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_touchscreen_expenses> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_touchscreen_expenses create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_touchscreen_expenses create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_touchscreen_expenses dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_touchscreen_expenses((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_touchscreen_expenses((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_touchscreen_expenses dialog = Dlg_touchscreen_expenses.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
    ...
    private void ok() {
        ...
        S1_expenses.to_expenses to = (S1_expenses.to_expenses) tbl_discounts_ALM.get(tbl_discounts.convertRowIndexToModel(row));
        if (callback != null) {
            callback.ok(new CloseDialog(this), new OutputData(to.expense_name, 0));
        }
    }
    ...
    private void init_tbl_discounts() {
        ...
        int[] tbl_widths_discounts = {100, 0, 0};
    ...
    private void loadData_discounts(List<S1_expenses.to_expenses> acc) {
    ...
    public static class TbldiscountsModel extends AbstractTableAdapter {
        ...
        public Object getValueAt(int row, int col) {
            S1_expenses.to_expenses tt = (S1_expenses.to_expenses) getRow(row);
            switch (col) {
                case 0:
    ...
    private void data_cols() {
        String search = "";
        S1_expenses.to_expenses to = new S1_expenses.to_expenses(-1,"");
        tbl_discounts_ALM.add(to);
        loadData_discounts(S1_expenses.ret_data(search));
    }
