 ...
 * @author Ronald
 */
public class Dlg_touchscreen_discounts extends javax.swing.JDialog {
...
//</editor-fold>
    ...
    private Dlg_touchscreen_discounts(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_touchscreen_discounts(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_touchscreen_discounts() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_touchscreen_discounts myRef;

    private void setThisRef(Dlg_touchscreen_discounts myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_touchscreen_discounts> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_touchscreen_discounts create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_touchscreen_discounts create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_touchscreen_discounts dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_touchscreen_discounts((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_touchscreen_discounts((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_touchscreen_discounts dialog = Dlg_touchscreen_discounts.create(new javax.swing.JFrame(), true);
...
//                btn_0.doClick();
    ...
    private void ok() {
        ...
        to_discounts to = (to_discounts) tbl_discounts_ALM.get(tbl_discounts.convertRowIndexToModel(row));
        if (callback != null) {
            callback.ok(new CloseDialog(this), new OutputData(to.discount_name, to.discount_rate));
        }
    }
    ...
    private void data_cols() {
        String search = "";
        loadData_discounts(S1_discounts.ret_where(search));
    }
