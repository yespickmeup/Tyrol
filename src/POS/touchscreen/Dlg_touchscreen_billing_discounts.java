 ...
 * @author Ronald
 */
public class Dlg_touchscreen_billing_discounts extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_touchscreen_billing_discounts
     */
...
//</editor-fold>
    ...
    private Dlg_touchscreen_billing_discounts(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_touchscreen_billing_discounts(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    public Dlg_touchscreen_billing_discounts() {
        super();
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_touchscreen_billing_discounts myRef;

    private void setThisRef(Dlg_touchscreen_billing_discounts myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_touchscreen_billing_discounts> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_touchscreen_billing_discounts create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_touchscreen_billing_discounts create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_touchscreen_billing_discounts dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_touchscreen_billing_discounts((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_touchscreen_billing_discounts((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_touchscreen_billing_discounts dialog = Dlg_touchscreen_billing_discounts.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        tf_discount_id.setFocusable(false);
        ...
        tf_discount_id.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tf_discount_idActionPerformed(evt);
            }
        });
        ...
        tf_discount_address.setFocusable(false);
                ...
                .addGroup(pnl_discountLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnl_discountLayout.createSequentialGroup()
                        .addGroup(pnl_discountLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(tf_discount_id, javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, pnl_discountLayout.createSequentialGroup()
                                .addComponent(tf_discount_name, javax.swing.GroupLayout.DEFAULT_SIZE, 201, Short.MAX_VALUE)
                                .addGap(1, 1, 1)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jXLabel9, javax.swing.GroupLayout.DEFAULT_SIZE, 78, Short.MAX_VALUE)
                            .addComponent(jXLabel17, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(jXLabel16, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGap(1, 1, 1)
...
//        search_item(tf_discount_customer_name);
    ...
    private void tf_discount_idActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tf_discount_idActionPerformed
        // TODO add your handling code here:
        init_description();
    }//GEN-LAST:event_tf_discount_idActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        tf_discount_id.setText("");
        tf_discount_customer_name.setText("");
    ...
    public void do_pass(double amount_due, String customer_names, String discount, double discount_rate, double discount_amount, String discount_customer_id, String discount_customer_names, String discount_customer_address) {

        jLabel1.setText("Customer/s: " + customer_names);
        jLabel11.setText(FitIn.fmt_wc_0(amount_due));
        lbl_net_due.setText(FitIn.fmt_wc_0(amount_due - discount_amount));

        tf_discount_name.setText(discount);
        tf_discount_rate.setText(FitIn.fmt_wc_0(discount_rate));
        tf_discount_amount.setText(FitIn.fmt_wc_0(discount_amount));
        jLabel13.setText(FitIn.fmt_wc_0(discount_amount));
        tf_discount_id.setText(discount_customer_id);
        tf_discount_customer_name.setText(discount_customer_names);
        tf_discount_address.setText(discount_customer_address);
...
//                btn_0.doClick();
    ...
    private void ok() {
        ...
        String discount_no = tf_discount_id.getText();
        String discount_name = tf_discount_customer_name.getText();
        String discount_address = tf_discount_address.getText();

        String where = " where id_no='" + discount_no + "'  ";
        S1_discount_customers.to_discount_customers disc = S1_discount_customers.ret_data3(where);
        System.out.println("" + disc.customer_name);
        if (disc.id == -1) {
            S1_discount_customers.to_discount_customers t = new S1_discount_customers.to_discount_customers(0, discount_name, discount_no);
            S1_discount_customers.add_discount_customers(t);
        }

        if (callback != null) {
            callback.ok(new CloseDialog(this), new OutputData(discount, discount_rate, discount_amount, discount_no, discount_name, discount_address));
        }
    }

    List<S1_discount_customers.to_discount_customers> description_list = new ArrayList();

    private void init_description() {
        String customer_id = tf_discount_id.getText();
        String customer_name = tf_discount_customer_name.getText();

        description_list.clear();
        String where = " where id_no  ='" + customer_id + "' "
                + "   group by id_no order by customer_name asc ";
        description_list = S1_discount_customers.ret_data2(where);
        Object[][] obj = new Object[description_list.size()][2];
        int i = 0;
        for (S1_discount_customers.to_discount_customers to : description_list) {
            obj[i][0] = to.id_no;
        ...
        if (description_list.isEmpty()) {
            tf_discount_customer_name.grabFocus();
        } else {
            JLabel[] labels = {};
            int[] tbl_widths_customers = {70, 300};
            int width = 400;
            String[] col_names = {"Id #", "Name"};
            TableRenderer tr = new TableRenderer();
            TableRenderer.setPopup(tf_discount_id, obj, labels, tbl_widths_customers, col_names);
            tr.setCallback(new TableRenderer.Callback() {
                @Override
                public void ok(TableRenderer.OutputData data) {
                    S1_discount_customers.to_discount_customers to = description_list.get(data.selected_row);
                    tf_discount_id.setText("" + to.id_no);
...
//      
    ...
    private void add_customer() {
        Window p = (Window) this;
        Dlg_touchscreen_customer_discounting nd = Dlg_touchscreen_customer_discounting.create(p, true);
        nd.setTitle("");
        nd.do_pass(tf_discount_id.getText(), tf_discount_customer_name.getText());
        nd.setCallback(new Dlg_touchscreen_customer_discounting.Callback() {

            @Override
            public void ok(CloseDialog closeDialog, Dlg_touchscreen_customer_discounting.OutputData data) {
                closeDialog.ok();
                tf_discount_id.setText(data.customer_id);
                tf_discount_customer_name.setText(data.customer_name);
            }
        });
