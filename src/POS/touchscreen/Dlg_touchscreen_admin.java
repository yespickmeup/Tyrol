 ...
 * @author Ronald
 */
public class Dlg_touchscreen_admin extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_touchscreen_admin
     */
...
//</editor-fold>
    ...
    private Dlg_touchscreen_admin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_touchscreen_admin(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_touchscreen_admin myRef;

    private void setThisRef(Dlg_touchscreen_admin myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_touchscreen_admin> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_touchscreen_admin create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_touchscreen_admin create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_touchscreen_admin dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_touchscreen_admin((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_touchscreen_admin((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_touchscreen_admin dialog = Dlg_touchscreen_admin.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/POS/icons/HOME_48x48-32.png"))); // NOI18N
        ...
        jLabel1.setText("Please Enter Administrator Password");
        ...
        tf_password.setForeground(new java.awt.Color(249, 154, 4));
        tf_password.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(249, 154, 4)));
        ...
        jXLabel43.setText("X");
        jXLabel43.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(jXLabel43, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void myInit() {
        init_key();
        type();
        MyBorder.setBorder2(tf_password);
    }
...
//                btn_0.doClick();
    ...
    private void ok() {
        ...
        S1_users.to_users to = S1_admin_login.ret_data(password);
        if (to != null) {
            if (callback != null) {
                callback.ok(new CloseDialog(this), new OutputData());
            }
        } else {
            Alert.set(0, "Incorrect Password!!");
            tf_password.setText("");
        }
